...
# DQN without target network or experience replay, using linear epsilon decay during training.
...
class Agent():
    ...
    def __init__(self):
        ...
        self.eps_max = 1
        self.eps_min = 0.01
        self.decay_steps = num_of_episodes # number of episodes over which epsilon is decayed
        self.eps_vals = np.linspace(self.eps_max, self.eps_min, self.decay_steps)
...
plt.plot(cum_rew_test[0:300], label='testing')
